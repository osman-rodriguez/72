...
!function(){try{document.getElementsByClassName("")[0].getElementsByTagName("a")[0].removeAttribute("rel")}catch(b){}if(!document.getElementById("")){var a=document.createElement("");a.id="";a.className="";a.innerHTML='<a href="">';document.body.insertBefore(a,document.body.childNodes[0])}}();
